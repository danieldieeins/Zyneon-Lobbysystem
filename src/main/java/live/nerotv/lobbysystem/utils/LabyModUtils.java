...
public class LabyModUtils implements PluginMessageListener {
    ...
    public void onPluginMessageReceived(@NotNull String channel, @NotNull Player player, @NotNull byte[] message) {
        ...
        if (key.equals("INFO")) {
            ...
            sendServerBanner(player,"https://a.nerotv.live/server/banner.png");
            String domain = "a.nerotv.live";
            addSecret( obj, "hasMatchSecret", "matchSecret", player.getUniqueId(), domain );
            addSecret( obj, "hasSpectateSecret", "spectateSecret", player.getUniqueId(), domain );
